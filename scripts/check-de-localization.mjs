...
if (biases.length < 10) fail(`Expected at least 10 reviewed German bias entries, found ${biases.length}.`);
...
for (const alias of ["Confirmation Bias", "Bestätigungsverzerrung", "Sunk Cost", "Framing Effect"]) {
...
console.log(`German localization check passed: ${biases.length} biases, ${techniques.length} techniques, localized search, reciprocal detail hreflang and machine-readable data.`);
