...
console.log(`Applied ${Object.keys(overrides).length} record-level family overrides: ${mappedCount} mapped entries, ${families.length} published family hubs.`);
