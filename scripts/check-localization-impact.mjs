...
function isLocaleReviewFile(file, locale) {
  ...
  const tokens = locale === "pt-BR" ? ["pt-br", "portuguese"] : locale === "fr" ? ["-fr", "/fr/", "french", "glossary-fr", "localization-fr"] : locale === "de" ? ["/de/", "german", "check-de", "generate-de"] : locale === "ru" ? ["/ru/", "russian", "check-ru", "generate-ru"] : [locale.toLowerCase()];
