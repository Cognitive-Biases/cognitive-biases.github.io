...
function reposition(html) {
  ...
  html = replaceAll(html, `<p>The library grew out of an earlier mobile app. The website is now the main project: we are keeping the useful corpus, reviewing it against research, improving weak wording and making the knowledge easier for people and other tools to reuse.</p>`, `<p>The library grew out of an earlier mobile app. The website is now the main project: we are keeping the useful corpus, reviewing it against research, improving weak wording and making the knowledge easier for people and other tools to reuse.</p><h2>Now part of Vedokrok</h2><p>Cognitive Biases started as an educational mobile app and became a practical reference for recognizing thinking errors. Awareness is the first step; the project’s strongest ideas and content are now part of <a href="https://vedokrok.com">Vedokrok</a> — a broader practical knowledge system that pairs awareness of thinking errors with concrete tools for better decisions, learning and action.</p><p><strong>Before:</strong> a focused project around one area of practical knowledge. <strong>Now:</strong> Vedokrok connects thousands of practical ideas, techniques, frameworks and tools across many areas of life and work — with collections, evidence, structured knowledge and future AI access.</p><p>This site remains online as a historical project and a useful standalone reference. Active development continues at <a href="https://vedokrok.com">Vedokrok</a>.</p>`);
