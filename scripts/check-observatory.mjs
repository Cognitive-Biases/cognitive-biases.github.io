...
assert(manifest.files?.observatory === `${SITE}/data/observatory.json`, "manifest missing Observatory dataset");
assert(manifest.counts?.observatoryObservations === sourceRecords, "manifest Observatory count drift");
