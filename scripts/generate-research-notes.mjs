...
function page(note) {
  ...
  const schema = {"@context":"https://schema.org","@type":"Article",headline:note.title,description:note.summary,datePublished:note.publishedAt,dateModified:note.publishedAt,mainEntityOfPage:canonical,isPartOf:{"@type":"WebSite",name:"Cognitive Biases",url:SITE}};
