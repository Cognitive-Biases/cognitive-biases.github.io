...
const files=["biases.json","evidence.json","sources.json","provenance.json","contexts.json","comparisons.json","relations.json","research-notes.json","rag.ndjson","rag-manifest.json","metrics.json","review-queue.json","translations.json","catalog.json","search-intents.json",...reports.map((r)=>`${r.slug}.json`),"evals/retrieval-citation.json"];
const manifestFiles=[];
