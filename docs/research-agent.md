...
The scheduled job should run the discovery and filtering stages, update the research inbox and prepare candidate notes. It should avoid direct automatic publication of scientific conclusions.
