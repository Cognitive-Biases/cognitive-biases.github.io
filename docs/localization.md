...
- `en` — canonical.
- `de` — reviewed human interface with full canonical bias coverage, techniques, Decision Skills, workflow/bias Agent Skills and reviewed problem-first decision situations.
...
- `fr` — reviewed human interface for the declared French bias, technique and Decision Skill surfaces.
...
Review terminology before bulk localization. First-class glossary sources include:
...
4. extend or retain the relevant locale checker;
